...
import com.wisdom.felicitas.expandable.layout.ExpandableLayout
import com.wisdom.felicitas.expandable.layout.ExpandableLayoutListenerAdapter
import com.wisdom.felicitas.expandable.layout.ExpandableLinearLayout
import com.wisdom.felicitas.expandable.layout.Utils
import java.util.*
...
class ExpandableRecyclerViewActivity : AppCompatActivity() {
    ...
    class RecyclerViewAdapter(private val data: List<ItemModel>) : RecyclerView.Adapter<RecyclerViewAdapter.ExpandableViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ExpandableViewHolder, position: Int) {
            ...
            context?.let {
                holder.itemView.setBackgroundColor(ContextCompat.getColor(it, item.colorId1))
            }
            holder.expandableLayout.setInRecyclerView(true)
            context?.let {
                holder.expandableLayout.setBackgroundColor(ContextCompat.getColor(it, item.colorId2))
            }
